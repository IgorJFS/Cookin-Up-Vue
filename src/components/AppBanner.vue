  ...
  <header class="banner">
    <div class="apresentacao">
      ...
      <p class="cabecalho-lg frase-cabecalho">
        <span class="texto-verde">A festa de ideias para</span>
        despertar o chef dentro de você!
      </p>
      <p class="subtitulo-lg">
        Explore novos receitas todos os dias com os ingredientes ao seu alcance!
      </p>
    </div>
